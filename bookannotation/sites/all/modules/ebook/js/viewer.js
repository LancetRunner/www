...
var PDFView = {
  ...
  set page(val) {
    ...
    //Display annotations of the current page
    if(annotPage!=currentPageNumber) {
        var book_id=document.getElementById('book_id').value;
        displayAnnot(book_id,currentPageNumber);
        annotPage=currentPageNumber;
    }
...
var PageView = function pageView(container, pdfPage, id, scale,
  ...
  /*    canvas.width = Math.floor(viewport.width);
   ...
   //   CustomStyle.setProp('transform' , canvas, 'scale(1,1)');
      ...
      if (textLayerDiv) {
          CustomStyle.setProp('transform' , textLayerDiv, 'scale(1,1)');
  ...
  this.appendText = function textLayerBuilderAppendText(geom) {
    ...
    textDiv.dataset.fontName = geom.fontName;
      ...
      textDiv.addEventListener('mousedown', function (e){
                               ...
                               startx=geom.x+e.offsetX;starty=geom.y+e.offsetY;
                               }, true);
      textDiv.addEventListener('mouseup', function (e){
                               var w=geom.x+e.offsetX-startx;
                               var h=geom.y+e.offsetY-starty;
                               ...
                               context.fillText("New", startx,starty);
                                ...
                                document.getElementById('startx').value=startx/canvasWidth;
                                document.getElementById('starty').value=starty/canvasHeight;
                                document.getElementById('width').value=w/canvasWidth;
                                document.getElementById('height').value=h/canvasHeight;
...
//#endif
 ...
 //temperarily treat it as a cancel button
  document.getElementById('fullscreen').addEventListener('click',
    function() {
            window.location.reload();/* PDFView.fullscreen();*/
    });
  ...
  document.getElementById('viewBookmark').addEventListener('click',
                                                           function() {
                                                           drawPencil();
                                                           document.getElementById('fullscreen').classList.remove('hidden');
                                                           });
